...
const projects = [
  {
    ...
    content: <p>A collaborative wiki for tutorials, FAQs, and documentation. <i>(this very website you're on!)</i></p>
  },
  {
    id: 2,
    ...
    <>
      ...
      <div className="flex flex-col px-2 pb-8">
        <Typography>
          ...
          <p>Whether you're an experienced developer or just starting, we welcome your contributions.</p>
